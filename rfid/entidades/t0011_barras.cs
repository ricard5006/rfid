...
{
    public class t0011_barras
    {
        public int f0011_id { get; set; }
        public int f0011_id_item { get; set; }
        ...
        public int f0011_habilitado { get; set; }
        public string f0011_creacion { get; set; }
        public string f0011_actualizacion { get; set; }
    }
}